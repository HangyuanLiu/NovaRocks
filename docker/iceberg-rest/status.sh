...
echo "  FE config: ${NOVAROCKS_FE_CONFIG:-$runtime_dir/fe.toml}"
echo "  BE config: ${NOVAROCKS_BE_CONFIG:-$runtime_dir/be.toml}"
echo "  sql-test config: ${NOVAROCKS_SQL_TEST_CONFIG:-$runtime_dir/sql-test.toml}"
...
echo "  NovaRocks FE Native gRPC port: ${NOVA_ENV_FE_GRPC_PORT:-unknown}"
echo "  NovaRocks FE management HTTP port: ${NOVA_ENV_FE_HTTP_PORT:-unknown}"
echo "  NovaRocks BE Native gRPC port: ${NOVA_ENV_BE_GRPC_PORT:-unknown}"
echo "  NovaRocks BE management HTTP port: ${NOVA_ENV_BE_HTTP_PORT:-unknown}"
