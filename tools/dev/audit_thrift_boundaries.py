...
BASELINE: dict[str, BaselineEntry] = {
    ...
    "src/runtime/runtime_filter_params.rs": BaselineEntry("legal-boundary", "B3-wire", 1, "Runtime filter params adapter converts FE thrift prober params into internal runtime endpoints"),
    ...
    "src/connector/iceberg/file_pruning_wire.rs": BaselineEntry("legal-boundary", "B5-wire", 1, "Iceberg file-pruning wire adapter converts min/max stats to and from HDFS thrift ranges"),
    ...
    "src/runtime/scan_range.rs": BaselineEntry("domain-leak", "B5", 0, "Runtime scan range model is native-only"),
    ...
    "src/connector/starrocks/fe_v2_meta.rs": BaselineEntry("legal-boundary", "B6-wire", 4, "StarRocks FE v2 metadata bridge retains only schema-fetch protocol adapters"),
    ...
    "src/runtime/dispatcher.rs": BaselineEntry("domain-leak", "control-plane", 0, "Runtime dispatcher sends native fragment requests"),
    ...
    "src/exec/operators/data_stream_sink.rs": BaselineEntry("legal-boundary", "control-plane-wire", 8, "Data stream sink emits exchange wire payloads and accepts native pre-lowered partition metadata"),
    ...
    "src/exec/operators/multi_cast_data_stream_sink.rs": BaselineEntry("legal-boundary", "control-plane-wire", 4, "Multicast data stream sink emits exchange wire payloads and accepts native pre-lowered partition metadata"),
    ...
    "src/exec/operators/iceberg_change_stream_router_sink.rs": BaselineEntry("legal-boundary", "control-plane-wire", 6, "Iceberg change-stream router sink consumes FE-compatible router and exchange branch metadata plus native pre-lowered partition metadata"),
    ...
    "src/engine/dml_change_stream.rs": BaselineEntry("domain-leak", "B7", 0, "DML change-stream writer mutates native distributed plans only"),
    ...
    "src/runtime/query_options.rs": BaselineEntry("legal-boundary", "B7-wire", 1, "Runtime query options adapter converts FE-compatible thrift options into internal runtime options"),
