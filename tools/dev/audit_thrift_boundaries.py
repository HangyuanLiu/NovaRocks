...
BASELINE: dict[str, BaselineEntry] = {
    ...
    "src/connector/iceberg/state.rs": BaselineEntry("domain-leak", "B5", 2, "Iceberg state carries descriptor-table/cache snapshots for B5 descriptor work, not writer-report domain state"),
    "src/engine/iceberg_writer.rs": BaselineEntry("domain-leak", "B7", 14, "Standalone Iceberg writer retains standalone/codegen position-delete descriptors for later cleanup"),
    ...
    "src/engine/insert_flow.rs": BaselineEntry("domain-leak", "B7", 2, "Standalone insert flow still threads FE query options through engine paths outside a dedicated adapter"),
