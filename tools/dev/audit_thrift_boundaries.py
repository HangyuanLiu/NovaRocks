...
BASELINE: dict[str, BaselineEntry] = {
    ...
    "src/engine/dml_change_stream.rs": BaselineEntry("legal-boundary", "control-plane-wire", 18, "DML change-stream writer builds FE-compatible change-event expand and query-option payloads"),
