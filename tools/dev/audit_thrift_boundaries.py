...
BASELINE: dict[str, BaselineEntry] = {
    ...
    "src/runtime/coordinator.rs": BaselineEntry("legal-boundary", "control-plane-wire", 39, "Runtime coordinator transports FE-compatible control-plane payloads"),
    ...
    "src/exec/operators/iceberg_change_stream_router_sink.rs": BaselineEntry("legal-boundary", "control-plane-wire", 3, "Iceberg change-stream router sink consumes FE-compatible router and exchange branch metadata"),
    ...
    "src/engine/dml_change_stream.rs": BaselineEntry("legal-boundary", "control-plane-wire", 14, "DML change-stream writer builds FE-compatible change-event expand and query-option payloads"),
