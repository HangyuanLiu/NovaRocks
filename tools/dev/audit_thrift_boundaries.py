...
BASELINE: dict[str, BaselineEntry] = {
    ...
    "src/runtime/native_fragment_wire.rs": BaselineEntry("legal-boundary", "control-plane-wire", 6, "Native fragment wire adapter converts native plan sidecars into FE-compatible runtime payloads"),
