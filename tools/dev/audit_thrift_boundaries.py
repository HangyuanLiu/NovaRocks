...
BASELINE: dict[str, BaselineEntry] = {
    ...
    "src/exec/chunk/schema.rs": BaselineEntry("domain-leak", "B7", 7, "Execution chunk schema retains a thrift compatibility sidecar for later execution type cleanup"),
