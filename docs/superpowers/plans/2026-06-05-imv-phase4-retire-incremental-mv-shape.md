...
**Canonical spec:** [docs/superpowers/specs/2026-06-04-iceberg-imv-refresh-property-framework-design.md](../specs/2026-06-04-iceberg-imv-refresh-property-framework-design.md) §13/§15. **Builds on** Phases 1–3 (PR #254). This branch: `claude/imv-phase4` (off #254 tip); PR fork→main, separate from #254.
...
**Update (2026-06-06).** Resolved by the join-delta decomposition (`docs/superpowers/specs/2026-06-06-imv-join-delta-decomposition-design.md`): `Aggregate(Filter(Join))` and multi-level inner/cross join nesting now refresh incrementally. join-of-aggregate and nested join-projection remain deferred.
