...
**Spec reference:** [`docs/superpowers/specs/2026-05-26-incremental-mv-optimizer-foundation-design.md`](../specs/2026-05-26-incremental-mv-optimizer-foundation-design.md) (commit `b75719aa`).
...
PR-α task 1 (per
docs/superpowers/plans/2026-05-26-incremental-mv-optimizer-foundation-pr-alpha.md):
...
PR-α of the combined PR-α / PR-β spec at [`docs/superpowers/specs/2026-05-26-incremental-mv-optimizer-foundation-design.md`](docs/superpowers/specs/2026-05-26-incremental-mv-optimizer-foundation-design.md). PR-β (marker operators) ships separately.
