...
1. **D2 spec** — `docs/superpowers/specs/2026-05-28-distributed-multi-be-execution-design.md` (823 lines). Read fully before touching code.
2. **D2 plan** — `docs/superpowers/plans/2026-05-28-distributed-multi-be-execution.md` (2613 lines). Each PR has scope / input / output / verification / rollback plus bite-sized TDD tasks.
3. **D1 spec** — `docs/superpowers/specs/2026-05-27-distributed-cross-process-mvp-design.md` (context on what's already built).
4. **Connector-first spec** — `docs/superpowers/specs/2026-05-28-connector-first-standalone-scan-design.md` (PR-0 builds on this).
...
1. Verify the D2 acceptance checklist at the end of the plan (`docs/superpowers/plans/2026-05-28-distributed-multi-be-execution.md`)
