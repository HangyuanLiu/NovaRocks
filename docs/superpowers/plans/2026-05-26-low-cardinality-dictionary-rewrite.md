...
```bash
rg -n "managed-lake|managed lake|ManagedLake|managed\\.database|managed\\.table|\\bmanaged\\b" src sql-tests docs -g '!docs/superpowers/plans/2026-05-25-sqlite-avro-metadata-schema.md'
...
rg -n "TBD|TODO|FIXME|implement later|fill in|appropriate error handling|Write tests for the above|Similar to Task" \
  docs/superpowers/plans/2026-05-26-low-cardinality-dictionary-rewrite.md | rg -v "rg -n"
```
