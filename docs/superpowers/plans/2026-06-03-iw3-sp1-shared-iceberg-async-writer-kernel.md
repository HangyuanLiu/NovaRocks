...
**Tech Stack:** Rust, iceberg-rs (`DataFileWriter`, `RecordBatchPartitionSplitter`, `FileIO`, `DefaultLocationGenerator`), arrow `RecordBatch`, parquet. Spec: `docs/superpowers/specs/2026-06-03-iw3-sp1-shared-iceberg-async-writer-kernel-design.md`.
