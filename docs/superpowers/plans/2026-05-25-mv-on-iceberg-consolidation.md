...
**Spec:** [docs/superpowers/specs/2026-05-25-mv-on-iceberg-consolidation-design.md](../specs/2026-05-25-mv-on-iceberg-consolidation-design.md)
...
```bash
grep -rn '"mv-on-iceberg"\|--suite mv-on-iceberg' tests/sql-test-runner/src/ docs/superpowers/ 2>/dev/null \
