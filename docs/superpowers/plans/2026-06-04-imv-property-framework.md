...
> Expand into its own plan (`docs/superpowers/plans/<date>-imv-refresh-property-derivation.md`) before implementing.
...
> Expand into its own plan (`docs/superpowers/plans/<date>-imv-refresh-capability-driver.md`) before implementing, after reading the relevant slices of `src/engine/mv/iceberg_refresh.rs`.
...
**Plan complete and saved to `docs/superpowers/plans/2026-06-04-imv-property-framework.md`** (Phase 1 executable; Phases 2–3 are roadmap spines to expand into their own plans). Two execution options:
