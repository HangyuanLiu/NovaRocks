...
- Spec: [docs/superpowers/specs/2026-05-26-incremental-mv-optimizer-foundation-design.md](../specs/2026-05-26-incremental-mv-optimizer-foundation-design.md), sections §8, §11 (PR-β), §3 (split rationale).
...
Spec: docs/superpowers/specs/2026-05-26-incremental-mv-optimizer-foundation-design.md §8.2 R1.
EOF
)"
```
