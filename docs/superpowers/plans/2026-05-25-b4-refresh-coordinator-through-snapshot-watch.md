...
cargo fmt --check
git add docs/superpowers/plans/2026-05-25-b4-refresh-coordinator-through-snapshot-watch.md src/engine/mv_scheduler.rs src/engine/mod.rs src/server/mod.rs src/common/app_config.rs
