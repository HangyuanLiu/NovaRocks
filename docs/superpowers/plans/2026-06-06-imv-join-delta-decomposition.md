...
**Spec:** [docs/superpowers/specs/2026-06-06-imv-join-delta-decomposition-design.md](../specs/2026-06-06-imv-join-delta-decomposition-design.md)
...
**Files:**
- Modify: `docs/superpowers/plans/2026-06-05-imv-phase4-retire-incremental-mv-shape.md`(Known limitation 标记已解)
...
在 `docs/superpowers/plans/2026-06-05-imv-phase4-retire-incremental-mv-shape.md` 的 "Known limitation" 段尾追加一行:

```markdown
**Update (2026-06-06):** Resolved by the join-delta decomposition
(docs/superpowers/specs/2026-06-06-imv-join-delta-decomposition-design.md):
...
```bash
git add docs/superpowers/plans/2026-06-05-imv-phase4-retire-incremental-mv-shape.md
