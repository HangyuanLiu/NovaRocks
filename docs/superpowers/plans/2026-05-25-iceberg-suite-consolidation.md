...
**Spec:** [docs/superpowers/specs/2026-05-25-iceberg-suite-consolidation-design.md](../specs/2026-05-25-iceberg-suite-consolidation-design.md)
...
```bash
grep -rn '"ddl"' tests/sql-test-runner/src/ docs/superpowers/ 2>/dev/null | grep -v "iceberg-ddl\|2026-05-25-iceberg" | head -5
```
