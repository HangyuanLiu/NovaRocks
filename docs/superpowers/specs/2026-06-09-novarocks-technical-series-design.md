...
- **关键代码**：`src/connector/iceberg/**`、`src/engine/iceberg_writer.rs`、`docs/iceberg-v3/**`、`docker/iceberg-rest/`。
...
- **关键代码**：`src/engine/mv_flow.rs`、IMV 相关 refresh 路径、`docs/superpowers/plans/` 中的 IMV/IVM 系列计划文档。
...
- 本设计文档：`docs/superpowers/specs/2026-06-09-novarocks-technical-series-design.md`
