                ...
                id_to_probers
                    ...
                    .map(|(filter_id, probers)| {
                        let destinations = probers
                            ...
                            .enumerate()
                            .map(|(idx, prober)| {
                                prober_params_from_thrift(prober).map_err(|e| {
