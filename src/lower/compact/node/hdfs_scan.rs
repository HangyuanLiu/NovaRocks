...
use crate::lower::compact::layout::{Layout, layout_from_slot_ids};
use crate::lower::compact::node::decode::{QueryGlobalDictMap, build_scan_query_global_dicts};
use crate::lower::compact::node::{Lowered, local_rf_waiting_set};
...
fn parse_hdfs_scan_variant_path_columns(
    ...
    for (idx, column) in variant_path_columns.iter().enumerate() {
        ...
        let requested_type = crate::lower::compact::type_lowering::arrow_type_from_desc(requested_type_desc)
            .ok_or_else(|| {
                format!(
...
mod tests {
    ...
    use crate::lower::compact::layout::layout_from_slot_ids;
    ...
    fn slot_binary_int_expr(
        ...
        let type_desc =
            crate::lower::compact::type_lowering::scalar_type_desc(types::TPrimitiveType::BIGINT);
        exprs::TExpr::new(vec![
            exprs::TExprNode {
