...
fn parse_hdfs_scan_variant_path_columns(
    ...
    for (idx, column) in variant_path_columns.iter().enumerate() {
        ...
        let requested_type = crate::lower::compat::type_lowering::arrow_type_from_desc(requested_type_desc)
            .ok_or_else(|| {
                format!(
...
mod tests {
    ...
    use crate::lower::compat::layout::layout_from_slot_ids;
    ...
    fn int_expr(value: i64) -> exprs::TExpr {
        exprs::TExpr::new(vec![exprs::TExprNode {
            ...
            type_: crate::lower::compat::type_lowering::scalar_type_desc(
    ...
    fn slot_binary_int_expr(
        ...
        let type_desc =
            crate::lower::compat::type_lowering::scalar_type_desc(types::TPrimitiveType::BIGINT);
        exprs::TExpr::new(vec![
            exprs::TExprNode {
    ...
    fn test_slot_ref_expr(slot_id: i32, tuple_id: i32) -> exprs::TExpr {
        let type_desc =
            crate::lower::compat::type_lowering::scalar_type_desc(types::TPrimitiveType::INT);
        exprs::TExpr::new(vec![exprs::TExprNode {
            node_type: exprs::TExprNodeType::SLOT_REF,
            type_: type_desc,
            num_children: 0,
