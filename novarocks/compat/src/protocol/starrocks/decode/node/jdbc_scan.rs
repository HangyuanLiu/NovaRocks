...
use novarocks::connector::jdbc::{JdbcInstanceConfig, plan_starrocks_jdbc_read_source};
use novarocks::exec::node::scan::ScanNode;
use novarocks::exec::node::{ExecNode, ExecNodeKind};
use novarocks::novarocks_connectors::{ConnectorRegistry, JdbcScanConfig};
...
pub(crate) fn lower_jdbc_scan_node(
    ...
    let mut out_layout = crate::protocol::starrocks::decode::layout::Layout {
        order: Vec::new(),
        index: HashMap::new(),
    };
