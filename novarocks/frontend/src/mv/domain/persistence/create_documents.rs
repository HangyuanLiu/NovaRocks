...
use novarocks_mv_application::persistence::validation::runtime::{
...
pub(crate) fn build_mv_create_documents(
    ...
    let interpretation = InterpretationDocument::try_from(RuntimeInterpretationFacts {
        definition_revision: novarocks_mv_application::persistence::codec::encode_definition(
            &definition,
        )
...
fn definition_outputs(
    facts: &SqlMvCreatePersistenceFacts,
    source: &BTreeMap<(u32, u32), FieldIdentity>,
    ids: &BTreeMap<u32, novarocks_mv_application::persistence::identity::OutputIdentity>,
...
fn branch_bindings(
    facts: &SqlMvCreatePersistenceFacts,
    outputs: &BTreeMap<u32, novarocks_mv_application::persistence::identity::OutputIdentity>,
    branches: &BTreeMap<u32, novarocks_mv_application::persistence::identity::BranchIdentity>,
