...
"#,
    ...
    if compat {
        // NIDL-E10 compat-only Rust proto codegen start
        wrapper.push_str(
            r#"
    pub mod starrocks {
...
"#,
        ...
        // NIDL-E10 compat-only Rust proto codegen end
    }

    wrapper.push_str("}\n");
    fs::write(out_dir.join("proto_root_mod.rs"), wrapper).expect("write proto_root_mod.rs");
}
...
fn main() {
    ...
    if compat {
        // NIDL-E10 compat-only generated IDL/codegen start
        ...
        let (tp_bin, tp_include, tp_lib, tp_lib64) = match &tp_resolved {
            ...
            None => unreachable!("compat feature requires thirdparty artifacts"),
        };
        ...
        // Rust thrift codegen for StarRocks-compatible builds.
        ...
        wrapper.push_str("pub mod thrift {\n");
...
static C++ runtime is required.",
        ...
        // NIDL-E10 compat-only generated IDL/codegen end
    }
    ...
    // Core generates only the Tonic service stubs against those external DTO
    // paths. StarRocks protos are generated explicitly below for compat and
    ...
    emit_proto_root_mod(&out_dir, compat);
}
