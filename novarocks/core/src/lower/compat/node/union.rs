...
use crate::lower::compat::layout::{Layout, chunk_schema_for_layout, layout_from_slot_ids};
...
mod tests {
    ...
    fn union_plan_node(result_expr_lists: Vec<Vec<exprs::TExpr>>) -> plan_nodes::TPlanNode {
        let mut node =
            crate::lower::compat::node::test_plan_node(9, plan_nodes::TPlanNodeType::UNION_NODE, 1);
