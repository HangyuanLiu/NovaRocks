...
mod tests {
    ...
    fn child_lowered() -> Lowered {
        let layout = crate::lower::compat::layout::layout_from_slot_ids(7, [10, 11, 12]);
        Lowered {
            node: ExecNode {
    ...
    fn lower_change_event_expand_carries_route_slots_and_events() {
        ...
        let out_layout =
            crate::lower::compat::layout::layout_from_slot_ids(8, [20, 21, 22, 30, 31]);
    ...
    fn lower_change_event_expand_rejects_missing_output_layout_slot() {
        ...
        let out_layout = crate::lower::compat::layout::layout_from_slot_ids(8, [20, 30, 31]);
    ...
    fn lower_change_event_expand_rejects_change_op_slot_missing_from_outputs() {
        ...
        let out_layout = crate::lower::compat::layout::layout_from_slot_ids(8, [20]);
    ...
    fn lower_change_event_expand_rejects_data_route_slot_missing_from_outputs() {
        ...
        let out_layout = crate::lower::compat::layout::layout_from_slot_ids(8, [20, 30]);
