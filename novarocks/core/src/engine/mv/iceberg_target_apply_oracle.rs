...
mod tests {
    ...
    fn referenced_partitions() -> ReferencedDataFilePartitions {
    ...
    fn framework_locate_matches_direct_locator_partitioned() {
        ...
        let mut referenced: ReferencedDataFilePartitions = std::collections::HashMap::new();
