...
pub enum EngineErrorCode {
    ...
    CommitUnknown,
    CommitKnownCommittedFinalizeFailed,
    QueryTimeout,
    ProtocolDecodeError,
...
impl EngineErrorCode {
    pub fn as_str(self) -> &'static str {
        match self {
            ...
            Self::CommitKnownCommittedFinalizeFailed => "CommitKnownCommittedFinalizeFailed",
    ...
    pub fn parse(input: &str) -> Option<Self> {
        match input {
            ...
            "CommitKnownCommittedFinalizeFailed" => Some(Self::CommitKnownCommittedFinalizeFailed),
