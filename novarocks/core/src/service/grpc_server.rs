...
impl GrpcService {
    ...
    pub fn with_fragment_execution(
        ...
        Self::with_handlers(
            ...
            report_handler,
            NativeDataPlaneKernel::query_scoped(),
        )
    }
    ...
    pub fn internal_execution_without_native_fragment_ingress(
        ...
        Self {
            endpoint_role: GrpcEndpointRole::CompatNeutral,
            #[cfg(any(test, feature = "query-execution-contract-test-support"))]
    ...
    pub fn report_ingress_only(report_handler: Arc<dyn NativeReportHandler>) -> Self {
        Self {
            endpoint_role: GrpcEndpointRole::ReportOnly,
            #[cfg(any(test, feature = "query-execution-contract-test-support"))]
            native_fragment_ingress: None,
            #[cfg(any(test, feature = "query-execution-contract-test-support"))]
            query_lifecycle_ingress: None,
    ...
    pub(crate) fn full_execution_with_handlers(
        ...
        Self::with_handlers(
            ...
            None,
            report_handler,
            NativeDataPlaneKernel::with_runtime_filter_envelope_ingress(
    ...
    pub(crate) fn full_execution_with_runtime_filter_manager(
        ...
        let mut service = Self::with_handlers(
            ...
            report_handler,
            NativeDataPlaneKernel::with_runtime_filter_envelope_ingress(
                crate::service::runtime_filter_envelope_ingress::query_scoped_runtime_filter_envelope_ingress_with_manager(manager),
            ),
        );
        service
    }
    ...
    /// Injects the listener-owned shutdown signal into the query-control
    /// stream. Role-specific listeners use this narrow hook without receiving
    /// access to core listener state.
    pub fn with_query_control_shutdown(mut self, shutdown: watch::Receiver<bool>) -> Self {
...
impl proto::novarocks::nova_rocks_grpc_server::NovaRocksGrpc for GrpcService {
    ...
    async fn exchange(
        ...
        tokio::spawn(async move {
            loop {
                ...
                let result = match tokio::task::spawn_blocking(move || kernel.exchange(req)).await {
                    Ok(r) => r,
                    Err(e) => {
                        let _ = tx
                            .send(Err(tonic::Status::internal(format!(
    ...
    async fn transmit_runtime_filter_envelope(
        ...
        let response =
            tokio::task::spawn_blocking(move || kernel.transmit_runtime_filter_envelope(request))
                .await
                .map_err(|error| {
    ...
    async fn cancel_fragment(
        ...
        #[cfg(not(any(test, feature = "query-execution-contract-test-support")))]
        {
            ...
            return Err(tonic::Status::failed_precondition(
                "core NovaRocksGrpc endpoint does not own CancelFragment",
            ));
        }
        #[cfg(any(test, feature = "query-execution-contract-test-support"))]
        {
    ...
    > {
        #[cfg(not(any(test, feature = "query-execution-contract-test-support")))]
        {
            let _ = request;
            return Err(tonic::Status::failed_precondition(
                "core NovaRocksGrpc endpoint does not own EnsureConnectorExecutionBinding",
            ));
        }
        #[cfg(any(test, feature = "query-execution-contract-test-support"))]
        {
    ...
    > {
        #[cfg(not(any(test, feature = "query-execution-contract-test-support")))]
        {
            let _ = request;
            return Err(tonic::Status::failed_precondition(
                "core NovaRocksGrpc endpoint does not own RetireConnectorExecutionBinding",
            ));
        }
        #[cfg(any(test, feature = "query-execution-contract-test-support"))]
        {
    ...
    async fn heartbeat(
        ...
        #[cfg(not(any(test, feature = "query-execution-contract-test-support")))]
        {
            let _ = request;
            return Err(tonic::Status::failed_precondition(
                "core NovaRocksGrpc endpoint does not own Heartbeat",
            ));
        }
        #[cfg(any(test, feature = "query-execution-contract-test-support"))]
        {
    ...
    async fn init_query(
        ...
        #[cfg(not(any(test, feature = "query-execution-contract-test-support")))]
        {
            let _ = request;
            return Err(tonic::Status::failed_precondition(
                "core NovaRocksGrpc endpoint does not own InitQuery",
            ));
        }
        #[cfg(any(test, feature = "query-execution-contract-test-support"))]
        {
    ...
    async fn stage_fragments(
        ...
        #[cfg(not(any(test, feature = "query-execution-contract-test-support")))]
        {
            let _ = request;
            return Err(tonic::Status::failed_precondition(
                "core NovaRocksGrpc endpoint does not own StageFragments",
            ));
        }
        #[cfg(any(test, feature = "query-execution-contract-test-support"))]
        {
    ...
    async fn start_prepared_query(
        ...
        #[cfg(not(any(test, feature = "query-execution-contract-test-support")))]
        {
            let _ = request;
            return Err(tonic::Status::failed_precondition(
                "core NovaRocksGrpc endpoint does not own StartPreparedQuery",
            ));
        }
        #[cfg(any(test, feature = "query-execution-contract-test-support"))]
        {
    ...
    async fn abort_query(
        ...
        #[cfg(not(any(test, feature = "query-execution-contract-test-support")))]
        {
            let _ = request;
            return Err(tonic::Status::failed_precondition(
                "core NovaRocksGrpc endpoint does not own AbortQuery",
            ));
        }
        #[cfg(any(test, feature = "query-execution-contract-test-support"))]
        {
    ...
    async fn query_control_stream(
        ...
        #[cfg(not(any(test, feature = "query-execution-contract-test-support")))]
        {
            let _ = request;
            return Err(tonic::Status::failed_precondition(
                "core NovaRocksGrpc endpoint does not own QueryControlStream",
            ));
        }
        #[cfg(any(test, feature = "query-execution-contract-test-support"))]
        {
