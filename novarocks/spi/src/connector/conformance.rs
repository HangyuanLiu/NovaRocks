...
use super::{
    ...
    ConnectorHistoricalWriteRecovery, ConnectorRequestContext, ConnectorWriteControl,
};
...
mod tests {
    ...
    use crate::connector::{
        ...
        ConnectorInstanceIncarnation, ConnectorTableIdentity, ConnectorWriteOperationId,
        ConnectorWritePlan, ConnectorWritePlanningRequest, ConnectorWriteTargetRef,
    };
