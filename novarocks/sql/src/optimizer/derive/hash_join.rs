...
use crate::optimizer::property::{DistributionSpec, HashSource, OrderingSpec, PhysicalPropertySet};
...
) -> Option<crate::optimizer::optimized_tree::JoinExecutionDistribution> {
    match alt_kind {
        PropertyAlternativeKind::BroadcastJoin => {
            Some(crate::optimizer::optimized_tree::JoinExecutionDistribution::Broadcast)
        }
...
fn preserves_left(jk: &crate::common::JoinKind) -> bool {
...
fn hash_join_only_shuffle(join_type: crate::common::JoinKind) -> bool {
    use crate::common::JoinKind::*;
    matches!(join_type, RightOuter | RightSemi | RightAnti | FullOuter)
}

fn hash_join_only_broadcast(join_type: crate::common::JoinKind) -> bool {
    use crate::common::JoinKind::*;
...
mod tests {
    ...
    use crate::optimizer::property::HashSource;
    use crate::optimizer::scalar::ScalarArena;
    ...
    fn hash_join_legacy_concrete_distribution_limits_alternatives() {
        ...
        op.join_type = crate::analysis::JoinKind::RightOuter;
        ...
        op.join_type = crate::analysis::JoinKind::Inner;
    ...
    fn hash_join_right_semi_anti_and_full_alternatives_are_shuffle_only() {
        for join_type in [
            crate::analysis::JoinKind::RightSemi,
            crate::analysis::JoinKind::RightAnti,
    ...
    fn broadcast_with_type(jk: crate::analysis::JoinKind) -> TestHashJoinOp {
        join_op(jk, vec![eq(col(10), col(20))], JoinDistribution::Broadcast)
    }

    #[test]
    fn hash_join_broadcast_right_outer_returns_any() {
        let op = broadcast_with_type(crate::analysis::JoinKind::RightOuter);
        let left_out = PhysicalPropertySet {
            distribution: DistributionSpec::shuffle_agg([ColumnId(10)]),
            ordering: OrderingSpec::Any,
        };
    ...
    fn hash_join_broadcast_right_semi_returns_any() {
        let op = broadcast_with_type(crate::analysis::JoinKind::RightSemi);
        let left_out = PhysicalPropertySet {
            distribution: DistributionSpec::shuffle_agg([ColumnId(10)]),
            ordering: OrderingSpec::Any,
        };
    ...
    fn hash_join_broadcast_right_anti_returns_any() {
        let op = broadcast_with_type(crate::analysis::JoinKind::RightAnti);
        let left_out = PhysicalPropertySet {
            distribution: DistributionSpec::shuffle_agg([ColumnId(10)]),
            ordering: OrderingSpec::Any,
        };
    ...
    fn hash_join_broadcast_full_outer_returns_any() {
        let op = broadcast_with_type(crate::analysis::JoinKind::FullOuter);
        let left_out = PhysicalPropertySet {
            distribution: DistributionSpec::shuffle_agg([ColumnId(10)]),
            ordering: OrderingSpec::Any,
        };
