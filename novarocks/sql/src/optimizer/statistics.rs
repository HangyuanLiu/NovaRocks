...
use crate::optimizer::stats_input::{StatsMissingReason, StatsSource};
...
impl TableStatistics {
    pub(crate) fn try_from_base_stats_with_confidence(
        base: &crate::optimizer::stats_input::BaseTableStatistics,
    ) -> Option<(Self, Confidence)> {
        use crate::optimizer::stats_input::StatValue;
