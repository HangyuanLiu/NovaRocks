...
use crate::optimizer::statistics::{Confidence, Statistics};
...
fn atom_output_column(
    ...
    atom: GroupId,
    column_id: ColumnId,
) -> Option<crate::common::OutputColumn> {
    memo.groups
        .get(atom)
        .and_then(|group| group.logical_props.as_ref())
        .and_then(|props| {
...
mod tests {
    use super::*;
    use crate::common::{BinOp, LiteralValue, OutputColumn};
    use crate::optimizer::memo::{JoinTree, LogicalProperties, MExpr};
