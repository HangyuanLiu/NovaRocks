...
use crate::optimizer::operator::{Operator, ProjectOp, SortOp, TopNOp, TopNPhase, UnionOp};
...
use crate::optimizer::scalar::{ColumnDisplay, ScalarArena, ScalarNode, SortKey as ScalarSortKey};
use crate::optimizer::topn_proof::{
...
mod tests {
    ...
    use crate::optimizer::rule::NewExpr;
