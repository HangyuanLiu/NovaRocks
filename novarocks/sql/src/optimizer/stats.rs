...
use crate::common::{BinOp, JoinKind, LiteralValue, OutputColumn, UnOp};
use crate::optimizer::estimate::arith::{damped_conjunction, sat_add};
use crate::optimizer::estimate::cardinality::{
...
use crate::optimizer::stats_input::{OptimizerStatsInput, StatsSource};
...
fn widen_for_join_kind(
    ...
    left_cols: Vec<crate::common::OutputColumn>,
    right_cols: Vec<crate::common::OutputColumn>,
...
fn derive_output_columns(memo: &Memo, group_idx: usize) -> Vec<crate::common::OutputColumn> {
    let group = &memo.groups[group_idx];
...
mod tests {
    ...
    use crate::optimizer::estimate::selectivity::estimate_selectivity;
    ...
    fn aggregate_stats_are_independent_of_split_stage_metadata() {
        ...
        use crate::optimizer::operator::{AggStage, LogicalAggregateOp, Operator, ValuesOp};
    ...
    fn logical_union_all_saturates_rows_and_caps_merged_column_ndv() {
        use crate::optimizer::estimate::arith::MAX_ROW_COUNT;
    ...
    fn logical_intersect_halves_min_rows_and_uses_min_column_ndv() {
        use crate::optimizer::operator::{IntersectOp, Operator};
    ...
    fn logical_except_halves_first_rows_and_merges_column_stats_with_min_ndv() {
        use crate::optimizer::operator::{ExceptOp, Operator};
    ...
    fn logical_aggregate_stats_use_damped_group_ndv_and_child_confidence() {
        use crate::optimizer::operator::{LogicalAggregateOp, Operator};
    ...
    fn physical_hash_aggregate_stats_use_damped_group_ndv_and_child_confidence() {
        use crate::optimizer::operator::{AggMode, Operator, PhysicalHashAggregateOp};
    ...
    fn derive_statistics_is_child_sensitive_across_groups() {
        ...
        use crate::column_id::ColumnId;
        use crate::optimizer::memo::{LogicalProperties, MExpr, Memo};
        use crate::optimizer::operator::{AggMode, Operator, PhysicalHashAggregateOp, ValuesOp};
        use crate::optimizer::statistics::ColumnStatistic;
    ...
    fn logical_filter_caps_payload_ndv_at_output_rows() {
        use crate::optimizer::operator::{FilterOp, Operator};
    ...
    fn logical_join_stats_use_shared_cardinality_estimator_for_condition() {
        use crate::optimizer::memo::{LogicalProperties, MExpr};
        use crate::optimizer::operator::{LogicalJoinOp, Operator, ValuesOp};
    ...
    fn physical_nest_loop_join_stats_use_shared_cardinality_estimator_for_non_equi_semi() {
        use crate::optimizer::memo::{LogicalProperties, MExpr};
        use crate::optimizer::operator::{Operator, PhysicalNestLoopJoinOp, ValuesOp};
    ...
    fn window_stats_preserve_child_columns_and_mark_window_outputs_fallback() {
        use crate::optimizer::memo::{LogicalProperties, MExpr};
        use crate::optimizer::operator::{Operator, ValuesOp, WindowOp};
    ...
    fn cte_consume_remaps_produce_column_statistics_to_consume_columns() {
        use crate::optimizer::memo::{LogicalProperties, MExpr};
        use crate::optimizer::operator::{CTEConsumeOp, Operator, ValuesOp};

        let cte_id: crate::analysis::cte::CteId = 1;
        let mut memo = Memo::new();
    ...
    fn generate_series_synthesizes_exact_column_statistics() {
        use crate::optimizer::memo::MExpr;
        use crate::optimizer::operator::{GenerateSeriesOp, Operator};
    ...
    fn table_function_passes_through_child_column_statistics() {
        use crate::optimizer::memo::{LogicalProperties, MExpr};
        use crate::optimizer::operator::{Operator, TableFunctionOp, ValuesOp};
    ...
    fn abc_join_tree(a: usize, b: usize, c: usize) -> crate::optimizer::memo::JoinTree {
        use crate::optimizer::memo::JoinTree;
    ...
    fn pick_representative_ffewerconj_prefers_fewer_join_conjuncts() {
        ...
        use crate::optimizer::memo::LogicalProperties;
        use crate::optimizer::operator::{LogicalJoinOp, ValuesOp};
...
mod join_widening_tests {
    use super::*;
    use crate::analysis::{JoinKind, OutputColumn};
    use arrow::datatypes::DataType;
