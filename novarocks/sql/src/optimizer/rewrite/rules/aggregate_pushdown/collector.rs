...
use crate::optimizer::operator::{LogicalAggregateOp, LogicalJoinOp, Operator};
...
mod tests {
    ...
    use super::*;
    use crate::analysis::{ExprKind, JoinKind, OutputColumn};
    use crate::column_id::ColumnId;
    ...
    fn hidden_aggregate_layout(
        group_by_typed: &[crate::analysis::TypedExpr],
    ...
    fn join_opt(
        join_type: JoinKind,
        condition: Option<crate::analysis::TypedExpr>,
        left: OptExpr,
        right: OptExpr,
        arena: &mut ScalarArena,
    ) -> OptExpr {
    ...
    fn rejects_aggregate_expr_not_columnref() {
        let mut arena = make_arena();
        use crate::analysis::BinOp;
        let non_col = crate::analysis::TypedExpr {
            kind: ExprKind::BinaryOp {
                left: Box::new(col_ref_typed("a", DataType::Int64)),
                op: BinOp::Add,
                right: Box::new(col_ref_typed("b", DataType::Int64)),
    ...
    fn adds_side_bound_join_key_to_extra_partial_groupby() {
        ...
        use crate::analysis::BinOp;
        let cond = crate::analysis::TypedExpr {
            kind: ExprKind::BinaryOp {
    ...
    fn rejects_qualified_required_columns_split_across_same_named_sides() {
        ...
        let cond = crate::analysis::TypedExpr {
            kind: ExprKind::BinaryOp {
                left: Box::new(crate::analysis::TypedExpr {
                    kind: ExprKind::BinaryOp {
