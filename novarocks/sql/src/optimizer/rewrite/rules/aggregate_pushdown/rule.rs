...
use crate::optimizer::rewrite::rule::LogicalRewriteRule as RewriteRule;
...
mod tests {
    ...
    fn idempotent_does_not_repush_already_pushed_plan() {
        use crate::analysis::{BinOp, ExprKind, JoinKind};
        use crate::optimizer::operator::{LogicalJoinOp, ScalarAggregateSpec};
        use crate::optimizer::scalar::ScalarArena;
        ...
        fn col_typed(name: &str) -> crate::analysis::TypedExpr {
        ...
        let cond_typed = crate::analysis::TypedExpr {
