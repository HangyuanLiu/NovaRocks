...
use crate::optimizer::operator::{Operator, ScalarWindowSpec, SortOp, WindowOp};
...
fn ranking_topn_type(name: &str) -> Option<crate::common::SqlTopNType> {
...
mod tests {
    ...
    fn make_window_spec_opt(
        ...
        ScalarWindowSpec {
            ...
            args: vec![],
            distinct: false,
            binding: crate::analysis::test_window_binding(fn_name, &[], DataType::Int64, false),
    ...
    fn ranking_window_rule_is_known() {
        assert!(
            crate::optimizer::rewrite::registry::is_known_rewrite_rule_name(
                "RankingWindowPredicatePushdown"
            )
        );
    }
