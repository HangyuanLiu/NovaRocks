...
use crate::optimizer::rewrite::rules::column_pruning::keep_at_least_one;
use crate::optimizer::rewrite::rules::utils::collect_output_ids_ordered_opt;
...
mod tests {
    use super::*;
    use crate::column_id::ColumnId;
    use crate::optimizer::operator::{Operator, UnionOp, ValuesOp};
    use crate::optimizer::opt_expr::OptExpr;
