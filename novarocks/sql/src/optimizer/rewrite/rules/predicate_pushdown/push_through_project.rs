...
use crate::optimizer::operator::{FilterOp, Operator, ProjectOp, ScalarProjectItem};
...
use crate::optimizer::rewrite::rules::utils::wrap_remaining_filter_opt_scalar;
...
mod tests {
    ...
    use crate::column_id::ColumnId;
    use crate::optimizer::operator::{FilterOp, Operator, ProjectOp, ScalarProjectItem, ScanOp};
    use crate::optimizer::opt_expr::OptExpr;
    use crate::optimizer::rewrite::context::RewriteContext;
    ...
    fn rewrites_qualified_alias_predicate_before_pushdown() {
        ...
        match result {
            RewriteResult::Changed(out) => {
                ...
                let pred_expr = crate::planner::optimizer_bridge::scalar::materialize(
                    &arena,
