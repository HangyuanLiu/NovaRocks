...
mod tests {
    use super::*;
    use crate::analysis::{BinOp, ExprKind, JoinKind, LiteralValue, TypedExpr};
    ...
    fn set_group_logical_rows_for_test(
        ...
        memo.groups[group].logical_props = Some(crate::optimizer::memo::LogicalProperties {
            output_columns: vec![],
            row_count: rows,
    ...
    fn set_group_logical_stats_for_test(
        ...
        let mut column = crate::optimizer::statistics::ColumnStatistic::unknown();
    ...
    fn make_large_build_inner_join_memo_for_test(
        probe_rows: f64,
        build_rows: f64,
        build_confidence: crate::optimizer::statistics::Confidence,
    ...
    fn make_expression_key_large_estimated_build_join_memo_for_test() -> (Memo, GroupId) {
        ...
        set_group_logical_rows_for_test(
            ...
            probe_group,
            3_543_657.0,
            crate::optimizer::statistics::Confidence::Estimated,
        );
        set_group_logical_rows_for_test(
            &mut memo,
            build_group,
    ...
    fn find_hash_join_for_test(plan: &OptimizedOperatorNode) -> Option<&PhysicalHashJoinOp> {
    ...
    fn search_uses_cost_estimate_total_for_winner_cost() {
        ...
        let estimate = crate::optimizer::statistics::CostEstimate {
            cpu_cost: 10.0,
            memory_cost: 1000.0,
            network_cost: 1000.0,
        };
    ...
    fn search_rejects_broadcast_for_fallback_large_build() {
        ...
        assert_eq!(
            winner.alt_kind,
            crate::optimizer::derive::PropertyAlternativeKind::ShuffleJoin
        );
    }
    ...
    fn search_broadcast_feasibility_uses_context_cost_options() {
        ...
        let required = PhysicalPropertySet::gather();
        let mut low_budget_profile = crate::optimizer::cost::ClusterResourceProfile::default();
        ...
        let mut high_budget_profile = crate::optimizer::cost::ClusterResourceProfile::default();
    ...
    fn search_prunes_broadcast_when_hash_table_exceeds_node_budget() {
        ...
        let mut profile = crate::optimizer::cost::ClusterResourceProfile::default();
...
mod cascaded_derivation_tests {
    ...
    use crate::optimizer::statistics::TableStatistics;
    use crate::planner::optimizer_bridge::scalar::intern_typed;
    use crate::planner::optimizer_bridge::scalar::intern_window_exprs;
    use arrow::datatypes::DataType;
    ...
    fn cascaded_output_through_broadcast_join_repartitions_after_join() {
        ...
        let bj_req = crate::optimizer::derive::derive_required(
            &window_expr.op,
            &memo.scalars,
