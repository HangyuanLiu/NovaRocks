...
use crate::optimizer::estimate::arith::{MAX_ROW_COUNT, damped_conjunction, sat_add, sat_mul};
...
mod tests {
    ...
    fn cross_join_saturates_with_fallback() {
        ...
        assert_eq!(rows, crate::optimizer::estimate::arith::MAX_ROW_COUNT);
        assert_eq!(conf, Confidence::Fallback);
    }
    ...
    fn inner_join_reports_fallback_when_intermediate_product_saturates() {
        ...
        assert!(rows < crate::optimizer::estimate::arith::MAX_ROW_COUNT);
        assert_eq!(conf, Confidence::Fallback);
    }
    ...
    fn multikey_semi_join_applies_matching_rows_once() {
        ...
        let key_selectivity =
            crate::optimizer::estimate::arith::damped_conjunction(&[0.001, 0.001]);
