...
fn p3_cube_without_grouping_survives_optimizer_id_binding() {
    ...
    crate::planner::optimizer_bridge::id_binding::verify_optimized_tree_id_binding(&optimized_tree)
...
fn test_explain_keeps_nested_cte_anchor_inside_subquery() {
    ...
    let lines = crate::explain::explain_plan(&plan, crate::explain::ExplainLevel::Normal);
...
fn window_reuses_ordering_through_derived_table() {
    ...
    let lines = crate::explain::explain_plan(&plan, crate::explain::ExplainLevel::Verbose);
...
fn apply_output_columns_extend_left_with_output_column() {
    ...
    use crate::planner::logical::{LogicalApplyNode, LogicalPlanKind};
...
fn apply_having_spec_emits_apply_above_aggregate() {
    ...
    assert_eq!(apply.kind, crate::common::ApplyKind::Scalar);
...
fn plan_with_single_predicate_apply_spec(
    sql: &str,
) -> (LogicalPlanNode, crate::analysis::ApplyPredicateSpec) {
...
fn plan_exists_builds_apply_exists() {
    ...
    assert_eq!(
        apply.kind,
        crate::common::ApplyKind::Exists { negated: false }
    );
...
fn plan_not_in_builds_apply_in_negated() {
    ...
    assert_eq!(apply.kind, crate::common::ApplyKind::In { negated: true });
