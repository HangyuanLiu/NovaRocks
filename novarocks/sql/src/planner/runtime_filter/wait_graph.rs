...
use crate::planner::runtime_filter::contract::{BindingId, ChannelId, CompletionRequirement};
    ...
    fn every_proof_rejection_keeps_the_wait_coarse() {
        ...
        completion_wait.producers[0].completion_requirement =
            CompletionRequirement::FencedFinalDomain(
                crate::planner::runtime_filter::contract::CompletionFenceKind::CommittedDomainFrozen,
            );
        assert_coarse(
            canonical.clone(),
            completion_wait,
