...
use crate::planner::payload::{PlanGenerateSeriesNode, PlanProjectNode, PlanScanNode};
...
pub(in crate::planner::distributed) enum NodeOutputError {
...
pub(in crate::planner::distributed) fn build_node_output_catalog(
...
pub(in crate::planner::distributed) fn build_fragment_edge_output_catalog(
    fragments: &[PlanFragment],
    edges: &[FragmentEdge],
...
/// in `crate::planner::physical`), which delegate to the canonical type
...
fn wire_project_item_output(item: &crate::analysis::ProjectItem) -> WireProjectItemOutput {
...
#[derive(Debug, PartialEq, Eq)]
pub(in crate::planner::distributed) enum WriteContractError {
...
mod tests {
    ...
    use crate::planner::distributed::write::sink::ConnectorWritePlanInput;
    ...
    // ---- Connector write output/target-schema + router partition ----
    ...
    fn write_contract_preserves_narrowed_dv_input_schema() {
        let fragment = try_write_fragment(
            ...
            vec![
                target_column("file_path", DataType::Int64, false),
                target_column("row_position", DataType::Int64, false),
            ],
        )
