...
impl FragmentCutBuilder {
    ...
    fn emit_stream_exchange(
        ...
        exchange_stats: crate::planner::physical::PhysicalPlanStats,
    ) -> Result<DistributedNode, String> {
    ...
    fn visit_cte_anchor(
        &mut self,
        node: &PhysicalPlanNode,
        _anchor: &crate::planner::payload::PlanCTEAnchorNode,
    ) -> Result<DistributedNode, String> {
        expect_child_count(node, 2)?;
    ...
    fn visit_cte_produce(
        &mut self,
        node: &PhysicalPlanNode,
        produce: &crate::planner::payload::PlanCTEProduceNode,
    ) -> Result<(), String> {
        expect_child_count(node, 1)?;
        let child_plan = &node.children[0];
...
fn limit_stats_with_child_cost(
    limit_stats: &crate::planner::physical::PhysicalPlanStats,
    child_stats: &crate::planner::physical::PhysicalPlanStats,
) -> crate::planner::physical::PhysicalPlanStats {
    crate::planner::physical::PhysicalPlanStats {
