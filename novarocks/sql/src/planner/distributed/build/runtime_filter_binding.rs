...
use crate::planner::distributed::{DistributedNode, DistributedNodeKind, FragmentId, PlanFragment};
...
use crate::planner::runtime_filter::comparator::comparator_digest_for_plan;
...
fn resolve_consumer_at(
    ...
    match &node.payload {
        ...
        DistributedNodeKind::SetOp(set_op)
            if matches!(
                set_op.kind,
                crate::planner::physical::PlanSetOpKind::UnionAll
            ) =>
        {
...
mod tests {
    ...
    use crate::planner::distributed::{DataPartition, DataSink, ExchangeFlavor, ExchangeReceiver};
    use crate::planner::payload::{PlanProjectNode, PlanValuesNode};
