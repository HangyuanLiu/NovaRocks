...
pub(in crate::planner::distributed) struct DistributedPlanValidationError(String);
...
#[derive(Debug, PartialEq, Eq)]
pub(in crate::planner::distributed) enum RuntimeFilterPlanValidationError {
...
pub(in crate::planner::distributed) fn validate_runtime_filter_graph_against_plan<A>(
...
pub(in crate::planner::distributed) fn validate_distributed_structure(
    fragments: &[PlanFragment],
...
mod tests {
    ...
    use crate::analysis::{ExprKind, OutputColumn as AnalysisOutputColumn, TypedExpr};
    use crate::column_id::ColumnId;
    use crate::planner::distributed::test_support::{
