    ...
    let case = TypedExpr {
        kind: ExprKind::Case {
            ...
            when_then: vec![(
                ...
                int_literal(i64::from(crate::common::CHANGE_OP_INSERT), DataType::Int8),
            )],
            else_expr: Some(Box::new(int_literal(
                i64::from(crate::common::CHANGE_OP_DELETE),
                DataType::Int8,
            ))),
        },
                ...
                JoinApplyActionProjection::ConstantInsert => TypedExpr {
                    kind: ExprKind::Cast {
                        expr: Box::new(int_literal(
                            i64::from(crate::common::CHANGE_OP_INSERT),
                            DataType::Int8,
                        )),
                        target: DataType::Int8,
                    },
...
fn is_internal_output_name(name: &str) -> bool {
    name.eq_ignore_ascii_case(crate::common::CHANGE_OP_COLUMN)
...
mod tests {
    ...
    use crate::analysis::{ExprKind, JoinKind, LiteralValue, OutputColumn, ProjectItem};
    ...
    use crate::planner::logical::{LogicalPlanKind, LogicalPlanNode, LogicalUnionNode};
    use crate::planner::optimizer_bridge::logical::{to_logical_plan, to_optimizer_expr};
    use crate::planner::payload::PlanValuesNode;
    use crate::planner::table::sql_mv_target_locator_scan;
    ...
    fn coalesce_plan_lowers_after_physical_optimization() {
        ...
        let result = crate::planner::optimizer_bridge::to_physical_plan(&optimized_tree);
    ...
    fn plan_exprs(plan: &LogicalPlanNode) -> Vec<&crate::analysis::TypedExpr> {
    ...
    fn expr_contains_string_literal(expr: &crate::analysis::TypedExpr, needle: &str) -> bool {
        match &expr.kind {
    ...
    ) -> Option<&crate::planner::table::SqlMvTargetLocatorScan> {
    ...
    fn test_coalesce_factory() -> crate::column_id::ColumnRefFactory {
    ...
    fn optimize_for_test(plan: LogicalPlanNode) -> crate::optimizer::OptimizedOperatorNode {
    ...
    fn collect_column_refs(expr: &crate::analysis::TypedExpr, refs: &mut HashSet<ColumnId>) {
        match &expr.kind {
    ...
    fn assert_action_item(item: &ProjectItem) {
        ...
        assert_column_ref(&expr.kind, ColumnId(4), crate::common::CHANGE_OP_COLUMN);
    }
