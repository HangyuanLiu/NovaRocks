...
use crate::planner::imv_rewrite::join_delta_shape::{
...
impl ImvActionColumn {
    pub(crate) const NAME: &'static str = crate::common::CHANGE_OP_COLUMN;
    // Consumed by IMV refresh execution.
    #[allow(dead_code)]
    pub(crate) const INSERT_VALUE: i8 = crate::common::CHANGE_OP_INSERT;
    // Consumed by IMV refresh execution.
    #[allow(dead_code)]
    pub(crate) const DELETE_VALUE: i8 = crate::common::CHANGE_OP_DELETE;
    ...
    matches!(
        ...
        Some(
            SqlScanKind::FrozenInputSet { .. }
                | SqlScanKind::Data {
                    version: crate::planner::table::SqlTableVersionSelector::Snapshot(_)
...
mod tests {
    use super::*;
    use crate::analysis::{ExprKind, ProjectItem, TypedExpr};
    ...
    use crate::planner::logical::{LogicalPlanKind, LogicalUnionNode};
    ...
    fn validation_rejects_aggregate_above_delta() {
        use crate::planner::logical::LogicalAggregateNode;
    ...
    fn validation_rejects_join_above_delta() {
        ...
        use crate::planner::logical::LogicalJoinNode;
