...
pub(crate) fn build_target_state_scan_source(
    ...
    row_filter: crate::planner::table::SqlMvTargetStateRowFilter,
    partition_constraint: crate::planner::table::SqlMvTargetStatePartitionConstraint,
) -> ScanSource {
...
mod tests {
    use super::*;
    use crate::compiler::mv_rewrite::test_target_binding;
    ...
    fn sqlx2_mv_target_state_scan_source_carries_target_state_metadata() {
        ...
        let source = build_target_state_scan_source(
            ...
            crate::planner::table::SqlMvTargetStateRowFilter::DeltaInputRowIds {
