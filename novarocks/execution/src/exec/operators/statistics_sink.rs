...
use crate::exec::statistics::StatisticsBatchCollector;
...
mod tests {
    ...
    fn sink_emits_one_bounded_terminal_partial_after_all_drivers_finish() {
        ...
        let payload = handle
            ...
            .expect("payload");
        let partial =
            crate::exec::statistics::StatisticsFragmentPartial::try_from_payload(&payload)
                .expect("decode execution-owned partial");
        assert_eq!(
            partial,
            crate::exec::statistics::StatisticsFragmentPartial::try_from_payload(&payload)
