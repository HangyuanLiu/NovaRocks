...
pub struct RuntimeFilterDictionaryFoldCache {
...
impl RuntimeFilterDictionaryFoldCache {
    ...
    #[cfg(test)]
    #[allow(dead_code)]
    pub fn build_count_for_test(&self) -> usize {
        self.build_count
    }
}
...
pub fn filter_chunk_by_in_filters_with_exprs(
    arena: &ExprArena,
...
pub fn filter_chunk_by_in_filters_with_exprs_and_dict_cache(
    arena: &ExprArena,
    exprs: &HashMap<i32, ExprId>,
    filters: &[Arc<RuntimeInFilter>],
    chunk: Chunk,
...
pub fn filter_chunk_by_membership_filters_with_exprs(
    arena: &ExprArena,
    exprs: &HashMap<i32, ExprId>,
...
pub fn filter_chunk_by_membership_filters_with_exprs_and_dict_cache(
    arena: &ExprArena,
    exprs: &HashMap<i32, ExprId>,
    filters: &[Arc<RuntimeMembershipFilter>],
    chunk: Chunk,
...
pub fn filter_chunk_by_min_max_filters_with_exprs(
    arena: &ExprArena,
    exprs: &HashMap<i32, ExprId>,
...
pub fn filter_chunk_by_min_max_filters_with_exprs_and_dict_cache(
    arena: &ExprArena,
    exprs: &HashMap<i32, ExprId>,
    filters: &[(i32, Arc<RuntimeMinMaxFilter>)],
    chunk: Chunk,
