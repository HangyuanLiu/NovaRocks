//! Worker-owned runtime-filter fixtures.
//!
...
pub struct BackendRuntimeFilterFixture {
...
impl BackendRuntimeFilterFixture {
    ...
    pub const fn identity(&self) -> BackendParticipantIdentity {
        self.identity
    }

    pub fn producer_contract(&self) -> RuntimeFilterProducerContract {
        self.producer_contract.clone()
    }

    pub fn coverage(&self) -> BackendCoverage {
        self.coverage.clone()
    }

    pub fn membership_contribution(&self) -> RuntimeFilterContribution {
        self.membership_contribution.clone()
    }

    pub fn membership_contribution_with_values(
        &self,
    ...
    pub fn contribution_with_digest(&self, digest: [u8; 32]) -> RuntimeFilterContribution {
        RuntimeFilterContribution::new(
            RuntimeFilterContributionKind::Membership,
            digest,
