...
mod tests {
    ...
    use crate::native::instance::decode_instance_params;
    ...
    fn decode_request(
        fragment: plan::PlanFragment,
        params: proto::InstanceParams,
    ) -> Result<NativeFragmentRequest, crate::native::ingress::NativeFragmentIngressError> {
    ...
    fn expect_request_error(
        result: Result<NativeFragmentRequest, crate::native::ingress::NativeFragmentIngressError>,
        message: &str,
    ) -> crate::native::ingress::NativeFragmentIngressError {
        match result {
            Ok(_) => panic!("{message}"),
            Err(error) => error,
        }
