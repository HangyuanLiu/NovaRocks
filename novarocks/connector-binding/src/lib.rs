...
//! Role-neutral connector binding contracts.
//!
//! This crate packages one exact catalog's provider-selected services without
//! owning a registry, a retry policy, query lifecycle state, or a transport.
//! Frontend and backend applications own those concerns separately.
