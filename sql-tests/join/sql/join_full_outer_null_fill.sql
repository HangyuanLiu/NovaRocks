...
-- @tags=join,full_outer
-- Test Objective:
-- 1. Validate FULL OUTER JOIN semantics across matched and unmatched keys.
-- 2. Prevent regressions in coalesced key visibility for outer-join output.
-- Test Flow:
