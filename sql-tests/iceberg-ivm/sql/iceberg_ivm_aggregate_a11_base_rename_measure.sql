...
-- Method: Rename base column amount -> gross_amount through Spark, insert new rows through NovaRocks, refresh, and compare the MV with the rewritten base aggregate.
