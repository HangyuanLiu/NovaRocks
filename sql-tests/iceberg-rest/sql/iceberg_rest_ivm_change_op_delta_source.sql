...
-- @tags=iceberg_rest,mv,ivm,change_op,projection,aggregate,overwrite
-- Test Point:
--   Validate Iceberg-backed MV refresh over an Iceberg REST v3 row-lineage table
...
DROP DATABASE ivm_${uuid0} FORCE;
