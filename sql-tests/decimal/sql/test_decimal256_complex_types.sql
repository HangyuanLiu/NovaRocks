...
DROP TABLE IF EXISTS ${case_db}.decimal_array_test;
...
DROP TABLE IF EXISTS ${case_db}.decimal_map_test;
...
DROP TABLE IF EXISTS ${case_db}.decimal_struct_test;
...
DROP TABLE IF EXISTS ${case_db}.complex_nested_test;
