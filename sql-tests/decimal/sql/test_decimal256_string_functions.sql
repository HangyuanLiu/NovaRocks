...
-- Tests: String conversion of decimal256, CONCAT, LENGTH, SUBSTR, REGEXP operations

-- Create test table with Iceberg-compatible decimal types
-- query 1
-- @skip_result_check=true
CREATE TABLE ${case_db}.decimal_string_test (
    id INT,
...
-- Insert test data with various decimal patterns - using Iceberg-compatible decimal values
INSERT INTO ${case_db}.decimal_string_test VALUES
(1, 12345678901234567890123.123456789012345, 123456789012345678.12345678901234567890, 12345678901234567890123456789012345678, 'A'),
(2, -98765432109876543210987.456789012345678, -987654321098765432.45678901234567890123, -98765432109876543210987654321098765432, 'B'),
(3, 0.000000000000001, 0.00000000000000000001, 0, 'C'),
(4, 99999888887777766666555.999999999999999, 999998888877777666.99999999999999999999, 99999888887777766666555554444433333222, 'A'),
(5, -88888777776666655555444.888888888888888, -888887777766666555.88888888888888888888, -88888777776666655555444443333322222111, 'B'),
(6, 11111222223333344444555.111111111111111, 111112222233333444.11111111111111111111, 11111222223333344444555556666677777888, 'C'),
(7, -77777666665555544444333.777777777777777, -777776666655555444.77777777777777777777, -77777666665555544444333332222211111000, 'A');
...
FROM ${case_db}.decimal_string_test
ORDER BY id;
