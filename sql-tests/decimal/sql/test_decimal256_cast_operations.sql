-- Test decimal256 cast operations: casting between decimal256 and other types,
-- arithmetic with implicit casting, aggregation, CASE expressions,
-- comparison operators, UNION, and NULL handling.

-- Create test table with various data types
-- query 1
-- @skip_result_check=true
CREATE TABLE ${case_db}.cast_test_source (
    id int,
    bool_val boolean,
    tinyint_val tinyint,
