...
select regexp_replace(inspect_related_mv('dal_aaaa'), '"id":[0-9]+', '"id":0');

-- query 14
-- @skip_result_check=true
select regexp_replace(inspect_related_mv('dal_bbb'), '"id":[0-9]+', '"id":0');

-- query 15
-- @skip_result_check=true
select regexp_replace(inspect_related_mv('dim_ccc'), '"id":[0-9]+', '"id":0');

-- query 16
-- @skip_result_check=true
select regexp_replace(inspect_related_mv('join_mv1'), '"id":[0-9]+', '"id":0');

-- query 17
-- @skip_result_check=true
select regexp_replace(inspect_related_mv('join_mv2'), '"id":[0-9]+', '"id":0');
