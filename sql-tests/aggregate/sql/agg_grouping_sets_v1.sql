-- Migrated from dev/test/sql/test_grouping_sets/T/test_grouping_sets_v1
-- Test Objective:
-- 1. Validate GROUPING SETS, ROLLUP, CUBE with enable_rewrite_groupingsets_to_union_all=false.
...
-- query 1
-- Setup: disable union-all rewrite; create and populate tables
