...
-- Test Objective:
-- 1. Validate MV refresh and query results when the MV definition contains subqueries.
-- 2. Cover datetime/string cast semantics inside subquery predicates.
-- Source: dev/test/sql/test_materialized_view/T/test_materialized_view_with_subquery
