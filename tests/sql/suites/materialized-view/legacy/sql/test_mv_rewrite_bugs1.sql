...
-- Test Objective:
-- 1. Validate previously fixed MV rewrite regressions stay closed.
-- 2. Cover bug-driven edge cases on local rewrite planning.
-- Source: dev/test/sql/test_materialized_view/T/test_mv_rewrite_bugs1
