...
-- @slow
-- Test: Read/Write decimal256 (precision > 38) across boundary, overflow, FE cast null,
-- BE exception, special values, simple values, append-table rows, and rounding scenarios.
...
INSERT INTO ${case_db}.decimal_test_p60_s60_fe_null SELECT 0.1;
INSERT INTO ${case_db}.decimal_test_p60_s60_fe_null SELECT -0.1;
...
INSERT INTO ${case_db}.decimal_test_simple_p39_s10 SELECT -1;
INSERT INTO ${case_db}.decimal_test_simple_p39_s10 SELECT 0;
INSERT INTO ${case_db}.decimal_test_simple_p39_s10 SELECT 1.0000000000;
INSERT INTO ${case_db}.decimal_test_simple_p39_s10 SELECT -1.0000000000;
...
INSERT INTO ${case_db}.decimal_test_simple_p50_s25 SELECT -1;
INSERT INTO ${case_db}.decimal_test_simple_p50_s25 SELECT 0;
INSERT INTO ${case_db}.decimal_test_simple_p50_s25 SELECT 1.0000000000000000000000000;
INSERT INTO ${case_db}.decimal_test_simple_p50_s25 SELECT -1.0000000000000000000000000;
...
INSERT INTO ${case_db}.decimal_test_simple_p65_s32 SELECT -1;
INSERT INTO ${case_db}.decimal_test_simple_p65_s32 SELECT 0;
INSERT INTO ${case_db}.decimal_test_simple_p65_s32 SELECT 1.00000000000000000000000000000000;
INSERT INTO ${case_db}.decimal_test_simple_p65_s32 SELECT -1.00000000000000000000000000000000;
...
INSERT INTO ${case_db}.decimal_test_simple_p55_s1 SELECT -1;
INSERT INTO ${case_db}.decimal_test_simple_p55_s1 SELECT 0;
INSERT INTO ${case_db}.decimal_test_simple_p55_s1 SELECT 1.0;
INSERT INTO ${case_db}.decimal_test_simple_p55_s1 SELECT -1.0;
INSERT INTO ${case_db}.decimal_test_simple_p55_s1 SELECT 0.0;
INSERT INTO ${case_db}.decimal_test_simple_p55_s1 SELECT 1.1;
INSERT INTO ${case_db}.decimal_test_simple_p55_s1 SELECT -1.1;
...
INSERT INTO ${case_db}.decimal_test_simple_p70_s35 SELECT -1;
INSERT INTO ${case_db}.decimal_test_simple_p70_s35 SELECT 0;
INSERT INTO ${case_db}.decimal_test_simple_p70_s35 SELECT 1.00000000000000000000000000000000000;
INSERT INTO ${case_db}.decimal_test_simple_p70_s35 SELECT -1.00000000000000000000000000000000000;
...
INSERT INTO ${case_db}.decimal_test_simple_mixed_p60_s20 SELECT -1;
INSERT INTO ${case_db}.decimal_test_simple_mixed_p60_s20 SELECT 0;
INSERT INTO ${case_db}.decimal_test_simple_mixed_p60_s20 SELECT 1.0;
INSERT INTO ${case_db}.decimal_test_simple_mixed_p60_s20 SELECT -1.0;
INSERT INTO ${case_db}.decimal_test_simple_mixed_p60_s20 SELECT 0.0;
INSERT INTO ${case_db}.decimal_test_simple_mixed_p60_s20 SELECT 1.00000000000000000000;
INSERT INTO ${case_db}.decimal_test_simple_mixed_p60_s20 SELECT -1.00000000000000000000;
INSERT INTO ${case_db}.decimal_test_simple_mixed_p60_s20 SELECT 0.00000000000000000000;
INSERT INTO ${case_db}.decimal_test_simple_mixed_p60_s20 SELECT 1.10000000000000000000;
INSERT INTO ${case_db}.decimal_test_simple_mixed_p60_s20 SELECT -1.10000000000000000000;
...
INSERT INTO ${case_db}.decimal_test_p60_s58_default_scale SELECT 55;
INSERT INTO ${case_db}.decimal_test_p60_s58_default_scale SELECT -55;
...
INSERT INTO ${case_db}.decimal_test_p50_s48_default_scale SELECT 12;
INSERT INTO ${case_db}.decimal_test_p50_s48_default_scale SELECT -12;
...
INSERT INTO ${case_db}.decimal_test_p45_s43_default_scale SELECT 78;
INSERT INTO ${case_db}.decimal_test_p45_s43_default_scale SELECT -78;
...
INSERT INTO ${case_db}.decimal_test_p40_s38_default_scale SELECT 99;
INSERT INTO ${case_db}.decimal_test_p40_s38_default_scale SELECT -99;
-- Insert 9999 -> becomes 9999.000....(38 zeros) = 4+38=42 digits > 40, should cause BE exception
INSERT INTO ${case_db}.decimal_test_p40_s38_default_scale SELECT 9999;

-- Case 75: decimal(35, 33) - inserting integer will auto-pad 33 zeros
CREATE TABLE ${case_db}.decimal_test_p35_s33_default_scale (d1 decimal(35, 33))
TBLPROPERTIES ("format-version" = "3");
-- Insert 111 -> becomes 111.000....(33 zeros) = 3+33=36 digits > 35, should cause BE exception
INSERT INTO ${case_db}.decimal_test_p35_s33_default_scale SELECT 111;
INSERT INTO ${case_db}.decimal_test_p35_s33_default_scale SELECT -111;
-- Insert 11 -> becomes 11.000....(33 zeros) = 2+33=35 digits = 35, should work
INSERT INTO ${case_db}.decimal_test_p35_s33_default_scale SELECT 11;
INSERT INTO ${case_db}.decimal_test_p35_s33_default_scale SELECT -11;
...
INSERT INTO ${case_db}.decimal_test_p76_s75_default_scale SELECT 1;
INSERT INTO ${case_db}.decimal_test_p76_s75_default_scale SELECT -1;
...
INSERT INTO ${case_db}.decimal_test_p70_s68_default_scale SELECT 33;
INSERT INTO ${case_db}.decimal_test_p70_s68_default_scale SELECT -33;
...
INSERT INTO ${case_db}.decimal_test_p55_s53_default_scale SELECT 77;
INSERT INTO ${case_db}.decimal_test_p55_s53_default_scale SELECT -77;
-- Insert 7777 -> becomes 7777.000....(53 zeros) = 4+53=57 digits > 55, should cause BE exception
INSERT INTO ${case_db}.decimal_test_p55_s53_default_scale SELECT 7777;
...
INSERT INTO ${case_db}.decimal_test_p42_s40_boundary_default SELECT 12;
INSERT INTO ${case_db}.decimal_test_p42_s40_boundary_default SELECT -12;
-- Insert 1234 -> becomes 1234.000....(40 zeros) = 4+40=44 digits > 42, should cause BE exception
INSERT INTO ${case_db}.decimal_test_p42_s40_boundary_default SELECT 1234;
...
INSERT INTO ${case_db}.decimal_test_p50_s10_rounding SELECT 123.12345678904321;
INSERT INTO ${case_db}.decimal_test_p50_s10_rounding SELECT -123.12345678904321;
...
-- Case 85: Append table with decimal(39, 0) as value column
CREATE TABLE ${case_db}.decimal_append_test_p39_s0 (
...
-- query 2
SELECT * FROM ${case_db}.decimal_test_p39_s5 ORDER BY d1;

-- query 3
SELECT * FROM ${case_db}.decimal_test_p50_s10 ORDER BY d1;

-- query 4
SELECT * FROM ${case_db}.decimal_test_p65_s15 ORDER BY d1;

-- query 5
SELECT * FROM ${case_db}.decimal_test_p39_s0 ORDER BY d1;

-- query 6
SELECT * FROM ${case_db}.decimal_test_p76_s20 ORDER BY d1;

-- query 7
SELECT * FROM ${case_db}.decimal_test_p76_s40_fe_null ORDER BY d1;

-- query 8
SELECT * FROM ${case_db}.decimal_test_p76_s50_fe_null ORDER BY d1;

-- query 9
SELECT * FROM ${case_db}.decimal_test_p40_s35 ORDER BY d1;

-- query 10
SELECT * FROM ${case_db}.decimal_test_p50_s45 ORDER BY d1;

-- query 11
SELECT * FROM ${case_db}.decimal_test_p55_s50 ORDER BY d1;

-- query 12
SELECT * FROM ${case_db}.decimal_test_p76_s0 ORDER BY d1;

-- query 13
SELECT * FROM ${case_db}.decimal_test_p76_s76 ORDER BY d1;

-- query 14
SELECT * FROM ${case_db}.decimal_test_p75_s35 ORDER BY d1;

-- query 15
SELECT * FROM ${case_db}.decimal_test_p60_s30 ORDER BY d1;

-- query 16
SELECT * FROM ${case_db}.decimal_test_p55_s25 ORDER BY d1;

-- query 17
SELECT * FROM ${case_db}.decimal_test_p70_s69 ORDER BY d1;

-- query 18
SELECT * FROM ${case_db}.decimal_test_p41_s8 ORDER BY d1;

-- query 19
SELECT * FROM ${case_db}.decimal_test_p43_s12 ORDER BY d1;

-- query 20
SELECT * FROM ${case_db}.decimal_test_p47_s18 ORDER BY d1;

-- query 21
SELECT * FROM ${case_db}.decimal_test_p52_s25 ORDER BY d1;

-- query 22
SELECT * FROM ${case_db}.decimal_test_p58_s30 ORDER BY d1;

-- query 23
SELECT * FROM ${case_db}.decimal_test_p62_s35 ORDER BY d1;

-- query 24
SELECT * FROM ${case_db}.decimal_test_p68_s40 ORDER BY d1;

-- query 25
SELECT * FROM ${case_db}.decimal_test_p72_s45 ORDER BY d1;

-- query 26
SELECT * FROM ${case_db}.decimal_test_p42_s0 ORDER BY d1;

-- query 27
SELECT * FROM ${case_db}.decimal_test_p48_s0 ORDER BY d1;

-- query 28
SELECT * FROM ${case_db}.decimal_test_p54_s0 ORDER BY d1;

-- query 29
SELECT * FROM ${case_db}.decimal_test_p60_s0 ORDER BY d1;

-- query 30
SELECT * FROM ${case_db}.decimal_test_p66_s0 ORDER BY d1;

-- query 31
SELECT * FROM ${case_db}.decimal_test_p70_s0 ORDER BY d1;

-- query 32
SELECT * FROM ${case_db}.decimal_test_p45_s40 ORDER BY d1;

-- query 33
SELECT * FROM ${case_db}.decimal_test_p51_s45 ORDER BY d1;

-- query 34
SELECT * FROM ${case_db}.decimal_test_p57_s50 ORDER BY d1;

-- query 35
SELECT * FROM ${case_db}.decimal_test_p63_s55 ORDER BY d1;

-- query 36
SELECT * FROM ${case_db}.decimal_test_p69_s60 ORDER BY d1;

-- query 37
SELECT * FROM ${case_db}.decimal_test_p70_s45_fe_null ORDER BY d1;

-- query 38
SELECT * FROM ${case_db}.decimal_test_p65_s55_fe_null ORDER BY d1;

-- query 39
SELECT * FROM ${case_db}.decimal_test_p60_s60_fe_null ORDER BY d1;

-- query 40
SELECT * FROM ${case_db}.decimal_test_p41_s38 ORDER BY d1;

-- query 41
SELECT * FROM ${case_db}.decimal_test_p46_s42 ORDER BY d1;

-- query 42
SELECT * FROM ${case_db}.decimal_test_p56_s52 ORDER BY d1;

-- query 43
SELECT * FROM ${case_db}.decimal_test_p61_s58 ORDER BY d1;

-- query 44
SELECT * FROM ${case_db}.decimal_test_p67_s63 ORDER BY d1;

-- query 45
SELECT * FROM ${case_db}.decimal_test_p40_s20 ORDER BY d1;

-- query 46
SELECT * FROM ${case_db}.decimal_test_p45_s22 ORDER BY d1;

-- query 47
SELECT * FROM ${case_db}.decimal_test_p50_s25 ORDER BY d1;

-- query 48
SELECT * FROM ${case_db}.decimal_test_p55_s27 ORDER BY d1;

-- query 49
SELECT * FROM ${case_db}.decimal_test_p39_s19 ORDER BY d1;

-- query 50
SELECT * FROM ${case_db}.decimal_test_p76_s38 ORDER BY d1;

-- query 51
SELECT * FROM ${case_db}.decimal_test_p58_s29 ORDER BY d1;

-- query 52
SELECT * FROM ${case_db}.decimal_test_simple_p39_s0 ORDER BY d1;

-- query 53
SELECT * FROM ${case_db}.decimal_test_simple_p39_s10 ORDER BY d1;

-- query 54
SELECT * FROM ${case_db}.decimal_test_simple_p50_s0 ORDER BY d1;

-- query 55
SELECT * FROM ${case_db}.decimal_test_simple_p50_s25 ORDER BY d1;

-- query 56
SELECT * FROM ${case_db}.decimal_test_simple_p65_s0 ORDER BY d1;

-- query 57
SELECT * FROM ${case_db}.decimal_test_simple_p65_s32 ORDER BY d1;

-- query 58
SELECT * FROM ${case_db}.decimal_test_simple_p76_s0 ORDER BY d1;

-- query 59
SELECT * FROM ${case_db}.decimal_test_simple_p76_s38 ORDER BY d1;

-- query 60
SELECT * FROM ${case_db}.decimal_test_simple_p76_s60 ORDER BY d1;

-- query 61
SELECT * FROM ${case_db}.decimal_test_simple_p76_s76 ORDER BY d1;

-- query 62
SELECT * FROM ${case_db}.decimal_test_simple_p40_s39 ORDER BY d1;

-- query 63
SELECT * FROM ${case_db}.decimal_test_simple_p45_s44 ORDER BY d1;

-- query 64
SELECT * FROM ${case_db}.decimal_test_simple_p55_s1 ORDER BY d1;

-- query 65
SELECT * FROM ${case_db}.decimal_test_simple_p70_s35 ORDER BY d1;

-- query 66
SELECT * FROM ${case_db}.decimal_test_simple_mixed_p60_s20 ORDER BY d1;

-- query 67
SELECT * FROM ${case_db}.decimal_test_p76_s76_fe_null ORDER BY d1;

-- query 68
SELECT * FROM ${case_db}.decimal_test_p50_s30_fe_null ORDER BY d1;

-- query 69
SELECT * FROM ${case_db}.decimal_test_p40_s35_fe_null ORDER BY d1;

-- query 70
SELECT * FROM ${case_db}.decimal_test_p76_s10_fe_null ORDER BY d1;

-- query 71
SELECT * FROM ${case_db}.decimal_test_p76_s5_fe_null ORDER BY d1;

-- query 72
SELECT * FROM ${case_db}.decimal_test_p60_s58_default_scale ORDER BY d1;

-- query 73
SELECT * FROM ${case_db}.decimal_test_p50_s48_default_scale ORDER BY d1;

-- query 74
SELECT * FROM ${case_db}.decimal_test_p45_s43_default_scale ORDER BY d1;

-- query 75
SELECT * FROM ${case_db}.decimal_test_p40_s38_default_scale ORDER BY d1;

-- query 76
SELECT * FROM ${case_db}.decimal_test_p35_s33_default_scale ORDER BY d1;

-- query 77
SELECT * FROM ${case_db}.decimal_test_p76_s75_default_scale ORDER BY d1;

-- query 78
SELECT * FROM ${case_db}.decimal_test_p70_s68_default_scale ORDER BY d1;

-- query 79
SELECT * FROM ${case_db}.decimal_test_p55_s53_default_scale ORDER BY d1;

-- query 80
SELECT * FROM ${case_db}.decimal_test_p76_s76_zero_default ORDER BY d1;

-- query 81
SELECT * FROM ${case_db}.decimal_test_p65_s64_single_digit ORDER BY d1;

-- query 82
SELECT * FROM ${case_db}.decimal_test_p42_s40_boundary_default ORDER BY d1;

-- query 83
SELECT * FROM ${case_db}.decimal_test_p50_s10_rounding ORDER BY d1;

-- query 84
SELECT * FROM ${case_db}.decimal_test_p50_s10_overflow ORDER BY d1;

-- query 85
SELECT * FROM ${case_db}.decimal_test_p50_s10_both_overflow ORDER BY d1;

-- query 86
SELECT user_id, asset_id, shop_id, value FROM ${case_db}.decimal_append_test_p39_s0 ORDER BY user_id, asset_id, shop_id;

-- query 87
SELECT id1, id2, id3, decimal_value, decimal_nullable, regular_value
FROM ${case_db}.decimal_append_test_p50_s10
ORDER BY id1, id2, id3;

-- query 88
SELECT decimal_value FROM ${case_db}.decimal_append_test_p50_s10 WHERE id1 = 2 AND id2 = 'key002' AND id3 = 200;

-- query 89
SELECT COUNT(*), SUM(regular_value), MIN(decimal_value), MAX(decimal_value)
FROM ${case_db}.decimal_append_test_p50_s10;
