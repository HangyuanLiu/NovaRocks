...
-- query 5
-- @skip_result_check=true
-- The expected 65-value bitmap is inserted as one explicit row so the
-- append table stores exactly the value read by the query.
TRUNCATE TABLE ${case_db}.t_bitmap_str;
